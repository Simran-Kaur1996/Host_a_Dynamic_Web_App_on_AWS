...
Repository Contents
Reference Diagram: A visual diagram representing the AWS infrastructure.
Deployment Scripts: Automated scripts to set up the environment and deploy the website.
SQL Migration Script: A script to migrate the database schema from an SQL file in S3 to an RDS instance.
